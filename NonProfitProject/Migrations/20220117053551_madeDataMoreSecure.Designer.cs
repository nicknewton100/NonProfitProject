...
namespace NonProfitProject.Migrations
{
    ...
    [Migration("20220117053551_madeDataMoreSecure")]
    partial class madeDataMoreSecure
    {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRole", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "a6c6eb77-255f-4be9-9446-c12f0531c30d",
                            Name = "Employee",
            ...
            modelBuilder.Entity("NonProfitProject.Models.Committees", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            CommitteesID = 1,
                            CommitteeCreationDate = new DateTime(2022, 1, 17, 5, 35, 50, 471, DateTimeKind.Utc).AddTicks(4014),
                        ...
                        {
                            CommitteesID = 2,
                            CommitteeCreationDate = new DateTime(2022, 1, 17, 5, 35, 50, 471, DateTimeKind.Utc).AddTicks(4295),
                        ...
                        {
                            CommitteesID = 3,
                            CommitteeCreationDate = new DateTime(2022, 1, 17, 5, 35, 50, 471, DateTimeKind.Utc).AddTicks(4305),
            ...
            modelBuilder.Entity("NonProfitProject.Models.News", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            NewsLastUpdated = new DateTime(2022, 1, 17, 5, 35, 50, 471, DateTimeKind.Utc).AddTicks(828),
                            NewsPublishDate = new DateTime(2022, 1, 17, 5, 35, 50, 471, DateTimeKind.Utc).AddTicks(623),
                        ...
                        new
                        {
                            ...
                            NewsLastUpdated = new DateTime(2022, 1, 17, 5, 35, 50, 471, DateTimeKind.Utc).AddTicks(1353),
                            NewsPublishDate = new DateTime(2022, 1, 17, 5, 35, 50, 471, DateTimeKind.Utc).AddTicks(1343),
            ...
            modelBuilder.Entity("NonProfitProject.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ConcurrencyStamp = "eed24e04-5dbe-4c16-8c4c-224d5cdf0a77",
                            Email = "JohnJones@gmail.com",
                            EmailConfirmed = false,
                            LockoutEnabled = false,
                            PhoneNumberConfirmed = false,
                            ReceiveWeeklyNewsletter = false,
                            SecurityStamp = "37a14d03-4652-4a26-a204-ff7e1e424084",
