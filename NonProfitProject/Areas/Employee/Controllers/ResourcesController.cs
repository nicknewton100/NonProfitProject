...
{   //If admin, shows this page
    ...
    public class ResourcesController : DefaultEmployeeController
    {
        ...
        public ResourcesController(IWebHostEnvironment webHostEnvironment, NonProfitContext context, UserManager<NonProfitProject.Models.User> userManager) : base(context)
        {
